          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                } whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm flex items-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`}
              >
